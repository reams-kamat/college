		...
		<div class="row sec_row">
			...
			<div  class="col-md-10 content_bar">
				<div style="margin:50px;">
					...
					<a class="btn btn_color" href="rejected_post.php" type="submit">Rejected Post</a>
						
				</div>
				<div style="margin:50px;" >
					<h2 style="text-align: center;font-style:italic;"><b>Unapproved Post</b></h2>
					...
					<table class="table">
						...
						if (isset($_GET['page_no']) && $_GET['page_no']!="") {
							...
							$result_count = mysqli_query($connect,"SELECT COUNT(*) As total_records FROM `post` where `status` = 'pending'");
							$total_records = mysqli_fetch_array($result_count);
							$total_records = $total_records['total_records'];
						    $total_no_of_pages = ceil($total_records / $total_records_per_page);
							$second_last = $total_no_of_pages - 1; // total page minus 1

						    $result = mysqli_query($connect,"SELECT * FROM `post` where `status` = 'pending'  order by 1 desc LIMIT $offset, $total_records_per_page");
						    $i=1;
						...
						<tr>
							...
							<td><a href="action.php?id=<?php echo"$id"; ?>" name="approve" class="btn btn-success  btn-flat btn-sm"> Approve</a></td>
							<td ><a href="edit.php?edit=<?php echo"$id"; ?>">Edit</a> | <a href="delete.php?id=<?php echo"$id"; ?>">Delete</a></td>
							<td><a href="reject.php?id=<?php echo"$id"; ?>" class="btn btn-danger btn-flat btn-sm"> Reject</a></td>
						</tr>
							<?php
							 }
