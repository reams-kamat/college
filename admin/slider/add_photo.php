	...
	<div class="container-fluid">
		...
		<div class="row sec_row">
			...
			<div  class="col-md-10 content_bar">
				...
				<div style="margin:50px;" >
					<h2 style="text-align: center;font-style:italic;"><b>Upload Slider Image</b></h2>
					<?php
					// database connection
					include('../includes/connect.php');
						...
						if ( $_POST['content']=='') {
							...
							if ($image_type=="image/jpeg" or $image_type=="image/jpg" or $image_type=="image/png" or $image_type=="image/gif") {
								if ($image_size<=2000000) {
									...
									$query="INSERT INTO `slider`(`title`, `author`,`content`, `image`, `date`) VALUES ('$title','$author','$content','$image_name','$date')";
