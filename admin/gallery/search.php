	...
	<div class="container-fluid">
		...
		<div class="row sec_row">
			...
			<div  class="col-md-10 content_bar">
				...
				<div style="margin:50px;" >
					<h2 style="text-align: center;font-style:italic;"><b>Manage Photo</b></h2>
					...
					<table class="table">
						...
						<tbody>
							...
							if (isset($_GET['search'])){
								...
								$query="SELECT * FROM `gallery` where title like '%$search_id%' or content like '%$search_id%' or image like '%$search_id%'";
										 // var_dump($query); die();
