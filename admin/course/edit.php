	...
	<div class="container-fluid">
		...
		<div class="row sec_row">
			<div  class="col-md-2 side_bar"  >
				...
				$pid =$_GET['edit'];
				// var_dump($pid); die();
				$sql_query="SELECT * FROM `gallery` WHERE `id` = '$pid'";
			...
			<div  class="col-md-10 content_bar">
				<div style="margin:50px;">
					<a class="btn btn_color" href="delete.php?id=<?php echo $pid ; ?>"  type="submit">Delete This Photo</a>&nbsp;&nbsp;&nbsp;
			...
			if ($image_type=="image/jpeg" or $image_type=="image/jpg" or $image_type=="image/png" or $image_type=="image/gif") {
				if ($image_size<=2000000) {
					move_uploaded_file($image_tmp,"images/$image_name");
						// <!-- // echo "$iid;"; -->
					$sql_query ="UPDATE `gallery` SET `title`='$title',`author`='$author',
