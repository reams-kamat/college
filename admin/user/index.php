		...
		<div class="row sec_row">
			...
			<div  class="col-md-10 content_bar">
				<div style="margin:50px;">
					<a class="btn btn_color" href="add_user.php" type="submit">Add Users</a>&nbsp;&nbsp;&nbsp;
					...
					<table class="table" style="text-align:center;">
						<thead>
							<tr >
								...
								<th style="text-align:center;">Change Role To</th>					
						...
						if (isset($_GET['page_no']) && $_GET['page_no']!="") {
						    ...
						    $result = mysqli_query($connect,"SELECT * FROM `users`  order by 1 desc LIMIT $offset, $total_records_per_page");
						    $i=1;
