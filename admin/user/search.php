		...
		<div class="row sec_row">
			...
			<div  class="col-md-10 content_bar">
				<div style="margin:50px;">
					<a class="btn btn_color" href="admin/index.php" type="submit">Admin Users</a>&nbsp;&nbsp;&nbsp;
					<a class="btn btn_color" href="client/index.php" type="submit">Client Users</a>	
						
				</div>
				<div style="margin:50px;" >
					<h2 style="text-align: center;font-style:italic;"><b>Manage Users</b></h2>
					...
					<table class="table">
						...
						<tbody>
							...
							if (isset($_GET['search'])){
								...
								$query="SELECT * FROM `users` where username like '%$search_id%' or email like '%$search_id%' or image like '%$search_id%' or name like '%$search_id%' or address like '%$search_id%' or phn like '%$search_id%' AND role='admin' " ;
										 // var_dump($query); die();
							...
							<tr>
								...
								<td><?php echo substr($row['name'],0,80 ); ?></td>
								<td><button type="button" class="btn btn-success"><?php echo $row['role']; ?></button></td>
								<td><a href="change_role.php?id=<?php echo"$id"; ?>" type="button" class="btn btn-warning"><?php if ($role=='admin') {
									   echo "User";
								} else {
									   echo "Admin";								
								}
